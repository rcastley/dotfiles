...
install_file "$DOTFILES_DIR/zsh/.zprofile"        "$HOME/.zprofile"
install_file "$DOTFILES_DIR/git/.gitconfig"       "$HOME/.gitconfig"
install_file "$DOTFILES_DIR/git/ignore"           "$HOME/.config/git/ignore"
install_file "$DOTFILES_DIR/ghostty/config"       "$HOME/Library/Application Support/com.mitchellh.ghostty/config"
